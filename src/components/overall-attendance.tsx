...
export function OverallAttendance() {
    ...
    const { totalAttended, totalClasses, overallPercentage } = useMemo(() => {
    ...
    return (
        <motion.div
            className="glass-card running-border p-6 flex flex-col md:flex-row items-center justify-around gap-6"
