    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px] glass-card">
        <DialogHeader>
          ...
          <DialogDescription className={cn(isRadhaTheme && "text-white")}>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className={cn('font-semibold', isRadhaTheme && "text-white")}>Subject Name</FormLabel>
                  <FormControl>
            ...
            <div className="grid grid-cols-2 gap-4">
               <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className={cn('font-semibold', isRadhaTheme && "text-white")}>Classes Attended</FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className={cn('font-semibold', isRadhaTheme && "text-white")}>Total Classes</FormLabel>
                    <FormControl>
                      <Input type="number" {...field} onFocus={(e) => e.target.select()} />
                    </FormControl>
                    <FormMessage />
            ...
            <DialogFooter>
              <Button type="submit" className={cn("text-white w-full font-bold", isRadhaTheme ? "bg-gradient-to-r from-black to-pink-500" : "bg-gradient-to-r from-primary to-green-500")}>Add Subject</Button>
            </DialogFooter>
          </form>
        </Form>
      </DialogContent>
